"""
Django settings for review_renew project.
...
ALLOWED_HOSTS = ['ec2-54-234-120-86.compute-1.amazonaws.com', '54.234.120.86']
...
ROOT_URLCONF = 'review_renew.urls'
...
WSGI_APPLICATION = 'review_renew.wsgi.application'
